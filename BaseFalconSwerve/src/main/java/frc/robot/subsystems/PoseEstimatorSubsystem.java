...
public class PoseEstimatorSubsystem extends SubsystemBase {
  ...
  private static final List<Pose2d> targetPoses = Collections.unmodifiableList(List.of(
      new Pose2d(Units.inchesToMeters(70), Units.inchesToMeters(-33), Rotation2d.fromDegrees(180)),
  ...
  private final PhotonCamera photonCamera = new PhotonCamera("mmal_service_16.1");
