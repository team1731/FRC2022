...
/**
 * Taxi, get R2, Shoot 2, get R4, get R1, Shoot 2. Used when at least one cannot get 2nd cargo. *This is ideal.*
 * Starting Position: MIDDLE
 */
public class P4_PickupR2ShootThenPickupR4R1Shoot extends _DelayableStrafingAutoMode {
	...
	public P4_PickupR2ShootThenPickupR4R1Shoot(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "P4_PickupShoot2Twice", 0, trajectory1)
		);
