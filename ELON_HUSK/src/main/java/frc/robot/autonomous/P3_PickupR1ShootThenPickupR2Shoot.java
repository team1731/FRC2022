...
/**
 * Taxi, get R1, Shoot 2, get R2, Shoot. Used when at least one cannot get 2nd cargo.
 * Starting Position: TOP
 */
public class P3_PickupR1ShootThenPickupR2Shoot extends _DelayableStrafingAutoMode {
	...
	public P3_PickupR1ShootThenPickupR2Shoot(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "P3_PickupShoot2ThenPickupShoot1", 0, trajectory1)
		);
