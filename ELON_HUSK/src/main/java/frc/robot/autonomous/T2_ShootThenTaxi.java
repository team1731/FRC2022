...
/**
 * Shoot then Taxi. Used when Pickup isn't working
 * Starting Position: ANY
 */
public class T2_ShootThenTaxi extends _DelayableStrafingAutoMode {
	...
	public T2_ShootThenTaxi(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "T2_ShootThenTaxi", 0, trajectory1)
		);
