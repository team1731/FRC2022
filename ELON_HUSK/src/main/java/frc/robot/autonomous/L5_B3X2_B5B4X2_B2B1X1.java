...
public class L5_B3X2_B5B4X2_B2B1X1 extends _DelayableStrafingAutoMode {
	...
	public L5_B3X2_B5B4X2_B2B1X1(DriveSubsystem m_robotDrive, IntakeSubsystem m_intake2, LaunchSubsystem m_launch2) {

		String trajectoryJSON0 = "paths/output/L4-1.wpilib.json";
        String trajectoryJSON1 = "paths/output/L4-2.wpilib.json";
        String trajectoryJSON2 = "paths/output/L5-3.wpilib.json";
        String trajectoryJSON3 = "paths/output/L6-3.wpilib.json";
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			new ParallelCommandGroup(
				...
				createSwerveCommand(m_robotDrive, "L5_B3X2_B5B4X2_B2B1X1", -40.0, trajectory0,true)), // Drive to first ball	
			new WaitCommand(2),	
			new LaunchBallCommandStop(m_launch),

			createSwerveCommand(m_robotDrive, "L5_B3X2_B5B4X2_B2B1X1", -40.0, trajectory1,true),  // Drive to second ball

			createSwerveCommand(m_robotDrive, "L5_B3X2_B5B4X2_B2B1X1", -20.0, trajectory2,true),  //Drive to shooting location
