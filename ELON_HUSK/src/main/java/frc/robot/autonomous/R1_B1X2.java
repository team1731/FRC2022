...
public class R1_B1X2 extends _DelayableStrafingAutoMode {
	...
	public R1_B1X2(DriveSubsystem m_robotDrive, IntakeSubsystem m_intake2, LaunchSubsystem m_launch2) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "R1-1", 0, trajectory0,false).andThen(() -> m_robotDrive.drive(0, 0, 0 ,0, false, false)), // Drive to first ball	
			new WaitCommand(1),
			createSwerveCommand(m_robotDrive, "R1-1", 90, trajectory1,true).andThen(() -> m_robotDrive.drive(0, 0, 0 ,0, false, false)), // Drive to first ball	
