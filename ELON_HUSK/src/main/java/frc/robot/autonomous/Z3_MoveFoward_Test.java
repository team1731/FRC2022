...
public class Z3_MoveFoward_Test extends _DelayableStrafingAutoMode {

	private final String trajectory1JSON = AutoConstants.kPATH + "DriveForward.wpilib.json";
	...
	public Z3_MoveFoward_Test(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "Z3_MoveFoward_Test", 0, trajectory1)
		);
