...
/**
 * Taxi, get R1, Shoot, get R2, get R4, Shoot 2. Used when at least one cannot get 2nd cargo. *This is ideal if one cannot shoot.*
 * Starting Position: TOP
 */
public class P6_PickupR1ShootThenPickupR2R4Shoot extends _DelayableStrafingAutoMode {
	...
	public P6_PickupR1ShootThenPickupR2R4Shoot(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "P6_PickupR1Shoot2ThenPickupR2R4Shoot", 0, trajectory1)
		);
