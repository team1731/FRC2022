...
public class D2_B3X2 extends _DelayableStrafingAutoMode {
	...
	public D2_B3X2(DriveSubsystem m_robotDrive, IntakeSubsystem m_intake2, LaunchSubsystem m_launch2) {
		...
		String trajectoryJSON2 = "paths/output/D2-1.wpilib.json";
		String trajectoryJSON3 = "paths/output/D2-2.wpilib.json";
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			new LaunchBallCommandStop(m_launch),
			new LaunchCommandStart(m_launch,.3,true).raceWith(createSwerveCommand(m_robotDrive, "L4_B3L2_B5B4L2", -40.0, trajectory2,false)), // Drive to first ball
			new LaunchCommandStart(m_launch,.3,true).raceWith(createSwerveCommand(m_robotDrive, "L4_B3L2_B5B4L2", 180.0, trajectory3,false)), // Drive to first ball
			new LaunchBallCommandStart(m_launch),
			new LaunchCommandStart(m_launch,0.3,true).withTimeout(2),
