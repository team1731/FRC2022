...
/**
 * Taxi then shoot. Used when pickup isn't working
 * Starting Position: ANY
 */
public class T3_TaxiThenShoot extends _DelayableStrafingAutoMode {
	...
	public T3_TaxiThenShoot(DriveSubsystem m_robotDrive) {
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(
			...
			createSwerveCommand(m_robotDrive, "T3_TaxiThenShoot", 0, trajectory1)
		);
