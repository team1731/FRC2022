...
public class ShootClimbCommand extends CommandBase {
	 ...
	 */
	public ShootClimbCommand(ShootClimbSubsystem shootClimbSubsystem, SequencerSubsystem seqSubsystem,
	...
	public void initialize() {
		// m_ShootClimbSubsystem.disable(); Can't call this all the time it will make it
		// ineffective
	}
