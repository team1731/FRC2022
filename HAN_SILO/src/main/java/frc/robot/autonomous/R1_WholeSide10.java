    ...
    public R1_WholeSide10(DriveSubsystem m_robotDrive, IntakeSubsystem m_intake, SequencerSubsystem m_sequence,
        ...
        SequentialCommandGroup commandGroup = new SequentialCommandGroup(
            ...
            new ParallelCommandGroup(
                createSwerveCommand(m_robotDrive, "BACKWARD TO BUDDY 2", TrajectoryDirection.REV,
            ...
            new ParallelCommandGroup(    
                createSwerveCommand(m_robotDrive, "STRAFE TO PICKUP BUDDY 2", TrajectoryDirection.REV,
