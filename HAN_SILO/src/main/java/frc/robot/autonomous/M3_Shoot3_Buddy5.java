...
public class M3_Shoot3_Buddy5 extends _DelayableStrafingAutoMode {
	public M3_Shoot3_Buddy5(DriveSubsystem m_robotDrive, IntakeSubsystem m_intake, SequencerSubsystem m_sequence,
		...
		SequentialCommandGroup commandGroup = new SequentialCommandGroup(new WaitCommand(getInitialDelaySeconds()),
				...
				new ParallelCommandGroup(createSwerveCommand(m_robotDrive, "BACKWARD TO BUDDY 5",
				...
				new ParallelCommandGroup(createSwerveCommand(m_robotDrive, "STRAFE TO PICKUP BUDDY 5",
